...
<div id="header" class="container">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#" accesskey="3" title="">Add Contacts</a></li>
		...
		<div id="fbox1">
			...
			<ul class="style3">
				<li class="first">
					...
					<h3>WAVE CANTERY AMBRAY</h3>
					<p><a href="#">Address: Carmen, Cagayan de Oro, City.</a></p>
				</li>
				<li>
					<p class="date"><a href="#">FEB<b>16</b></a></p>
					<h3>ATHENA ABELLA LOUISSE</h3>
					<p><a href="#">Address: Gateway, Limketkai Drive CDO, City.</a></p>
				</li>
				<li>
					<p class="date"><a href="#">FEB<b>16</b></a></p>
					<h3>ANGELA CAGAS</h3>
					<p><a href="#">Address: Deluxe, Cogon CDO, City.</a></p>
				</li>
			</ul>
		</div>
		<div id="fbox2">

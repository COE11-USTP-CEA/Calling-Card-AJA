        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <i class="fa fa-exchange fa-3x"></i>
									...
									<p >
										Aja Calling Card is surely convenient, fast and hassle-free.
									</p>
 ...
 <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="text-align:right;padding:5px;">
                    &copy;2017 Calling Card | <a href="http://www.binarytheme.com/" style="color:#fff;" target="_blank" >Templeted By: Binarytheme.com</a>
                </div>
            </div>
    </div>
    </div>
